      ...
      <div className="container w-full mx-auto py-[60px] px-[20px] md:px-[50px] lg:px-[99px]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-[40px] items-center">
          <div>
            ...
            <button className="px-[30px] md:px-[50px] py-[12px] md:py-[20px] bg-[#054C73] rounded-[50px] text-white text-[14px] md:text-[16px] mon700 font-bold mt-[20px] md:mt-[30px] hover:bg-[black]">
              Learn More
            </button>
          </div>
          <Zoom down>
